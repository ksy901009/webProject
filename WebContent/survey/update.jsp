...
<script>
	$(document).ready(function() {
		$("#btnUpdate").click(function() {
			suntaek_proc('updateProc', '1', '${dto.no}');
		});
...
<form name="dirForm">
	<table border="1" align="center" width="80%">
		...
		<tr>
			...
			<td><input type="text" name="status" id="status" value="${dto.status }"></td>
		</tr>
		<tr>
			<td>start_date</td>
			<td>
		...
		<tr>
			<td>last_date</td>
			<td>
				<input type="text" name="last_date" id="last_date" value="${dto.last_date }">
