	...
	<table border="1" align="center" width="80%">
		...
		<tr>
			...
			<td>
				...
				<button type="button" id="id_check_win">아이디찾기(새창)</button><br>
		...
		<tr>
			<td>비밀번호확인</td>
			<td>
				<input type="password" name="passwdChk" id="passwdChk" value="">
			</td>
		</tr>
		<tr>
			<td>이름</td>
		...
		<tr>
			<td>성별</td>
			<td>
				<input type="radio" name="genderRadio" value="M" onclick="genderRadioChk(this.value);" checked> 남자&nbsp;&nbsp;&nbsp;
				<input type="radio" name="genderRadio" value="F" onclick="genderRadioChk(this.value);"> 여자<br>
		...
		<tr>
			<td>태어난년도</td>
			<td>
				<input type="text" name="bornYear" id="bornYear" value="1990">
			</td>
		</tr>
		<tr>
			<td rowspan="3">주소</td>
		...
		<tr>
			<td><input type="text" id="sample6_address" name="address" placeholder="주소"></td>
		</tr>
		<tr>
			<td>
...
<script>
	...
	function genderRadioChk(value1) {
		document.getElementById("gender").value = value1;
	}
	...
	function id_check_win() {
		window.open("${path}/member_servlet/id_check_win.do", "new", "width=640, height=480, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
	}
</script>
